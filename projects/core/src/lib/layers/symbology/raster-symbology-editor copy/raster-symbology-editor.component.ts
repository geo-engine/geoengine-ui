...
import {LinearGradient, LogarithmicGradient, PaletteColorizer, RgbaColorizer} from '../../../colors/colorizer.model';
...
export class RasterSymbologyEditorComponent implements OnDestroy, OnInit {
    ...
    getColorizerType(): 'linearGradient' | 'logarithmicGradient' | 'palette' | 'rgba' {
    ...
    updateColorizerType(colorizerType: 'linearGradient' | 'logarithmicGradient' | 'palette' | 'rgba'): void {
