...
/**
 * The `ge-map-container` component encapsulates openLayers maps.
 * It displays `ge-map-layer` components as child components, i.e., either layers on a single map or a grid of maps.
 */
@Component({
    selector: 'ge-map-container',
