...
export class ProjectService {
    ...
    private readonly selectedFeature$: BehaviorSubject<FeatureSelection> = new BehaviorSubject({layer: undefined, feature: undefined});
    ...
    setSelectedFeature(feature: OlFeature): void {
        this.selectedFeature$.next({feature: !!feature ? feature.ol_uid : undefined});
    }
