...
import {Symbology, SimplePointSymbology, SimpleVectorSymbology} from "../../../models/symbology.model";
...
export class SymbologyVectorComponent {
    ...
    @Output("symbologyChanged") symbologyChangedEmitter: EventEmitter<SimpleVectorSymbology> = new EventEmitter<SimpleVectorSymbology>();
