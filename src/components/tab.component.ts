...
import {MsgRadianceOperatorComponent, MsgReflectanceOperatorComponent, MsgSolarangleOperatorComponent, MsgTemperatureOperatorComponent, MsgPansharpenOperatorComponent} from "./operators/msg-operators.component";
