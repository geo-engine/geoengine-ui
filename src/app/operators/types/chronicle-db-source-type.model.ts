...
export class ChronicleDBSourceType extends OperatorType {
    ...
    static get TYPE(): string { return ChronicleDBSourceType._TYPE; }
    static get ICON_URL(): string { return ChronicleDBSourceType._ICON_URL; }
    static get NAME(): string { return ChronicleDBSourceType._NAME; }
