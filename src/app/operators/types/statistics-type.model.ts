...
export class StatisticsType extends OperatorType {
    ...
    static get TYPE(): string { return StatisticsType._TYPE; }
    static get ICON_URL(): string { return StatisticsType._ICON_URL; }
    static get NAME(): string { return StatisticsType._NAME; }
