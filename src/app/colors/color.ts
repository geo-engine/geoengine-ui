...
export class Color implements IRgba, RgbaStruct {
     ...
     * @param {RgbaLike} rgba: the rgba like input
     * @param {boolean} clone: clone if already an instance of Color. Defaults to TRUE!
     * @returns {Color}
     */
    static fromRgbaLike(rgba: RgbaLike, clone: boolean = true): Color {
        ...
        if ((<IRgba>rgba).rgbaStruct) {
            return new Color((<IRgba>rgba).rgbaStruct());
        }
