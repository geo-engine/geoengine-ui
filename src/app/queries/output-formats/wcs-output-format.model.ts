 ...
 * WCS Output Formats
 */
class WCSOutputFormatCollection {
    ...
    get TIFF(): WCSOutputFormat { return this._TIFF; };
    get TYPES(): Array<WCSOutputFormat> { return this._TYPES; }
    get EXPORT_TYPES(): Array<WCSOutputFormat> { return this._EXPORT_TYPES; }
}
...
export const WCSOutputFormats = new WCSOutputFormatCollection();
